    ...
    let Reader<'t> =
        ...
        let readField (r: RowReader) (n: string) (t: System.Type) =
            if t = typeof<int> then
                ...
                r.intArrayOrNone n |> box
            elif t = typeof<string[]> then
                r.stringArray n |> box
            elif t = typeof<string[] option> then
                r.stringArrayOrNone n |> box
        ...
        fun (reader: RowReader) ->
            let values =
                [| for (name, ty) in fields do
                       readField reader (name.ToLowerInvariant()) ty |]
